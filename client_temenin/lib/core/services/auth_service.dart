...
class AuthService {
  ...
  Future<Map<String, dynamic>> login(String email, String password) async {
    ...
    final candidateUrls = [
      ...
      'http://192.168.1.3:3004${ApiConstants.login}',
    ];
    ...
    for (final rawUrl in candidateUrls) {
      try {
        ...
        // Network failure or timeout, proceed to next candidate or fallback
      }
    }
  ...
  Future<Map<String, dynamic>> loginWithPhone(String phone, String otp) async {
    ...
    final candidateUrls = [
      '${ApiConstants.baseUrl}/api/auth/login-otp',
      'http://10.0.2.2:3004/api/auth/login-otp',
      'http://127.0.0.1:3004/api/auth/login-otp',
      'http://localhost:3004/api/auth/login-otp',
      'http://192.168.1.3:3004/api/auth/login-otp',
    ];
